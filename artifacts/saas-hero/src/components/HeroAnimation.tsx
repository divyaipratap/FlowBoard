...
const INIT_TASKS = [
  { id: 't1', title: 'Implement new auth flow', badge: 'Engineering', badgeColor: 'text-blue-400 bg-blue-500/10 border-blue-500/20', status: 0, assignee: null as string | null, comments: 0 },
  { id: 't2', title: 'Design system updates', badge: 'Design', badgeColor: 'text-pink-400 bg-pink-500/10 border-pink-500/20', status: 1, assignee: 'u2' as string | null, comments: 3 },
  { id: 't3', title: 'Q3 Marketing site refresh', badge: 'Marketing', badgeColor: 'text-yellow-400 bg-yellow-500/10 border-yellow-500/20', status: 2, assignee: 'u3' as string | null, comments: 8 },
  { id: 't4', title: 'Fix navigation layout bug', badge: 'Bug', badgeColor: 'text-red-400 bg-red-500/10 border-red-500/20', status: 0, assignee: null as string | null, comments: 1 },
];
...
export function HeroAnimation() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      const elapsed = Date.now() % LOOP_DURATION;
      setTime(elapsed);
